 ...
 * Provides database operations for RoutePrice entities including CRUD operations
 * and custom query methods to interact with the 'route_price' table.
 * 
 * This repository is used by the RoutePrice service to perform all database-related operations.
 */
@Repository
