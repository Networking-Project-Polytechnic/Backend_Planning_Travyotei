...
public class BusTypeController {
     ...
     * @return ResponseEntity with the created bus type DTO and HTTP 201 Created status
     */
    @PostMapping
     ...
     * @return ResponseEntity with the bus type DTO if found, otherwise 404 Not Found
     */
     ...
     * @return ResponseEntity with the updated bus type DTO if successful, otherwise 404 Not Found
     */
