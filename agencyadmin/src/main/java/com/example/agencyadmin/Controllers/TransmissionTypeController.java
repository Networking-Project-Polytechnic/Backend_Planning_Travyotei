...
public class TransmissionTypeController {
     ...
     * @return ResponseEntity with the created transmission type DTO and HTTP 201 Created status
     */
    @PostMapping
    public ResponseEntity<TransmissionTypeDTO> createTransmissionType(@RequestBody TransmissionTypeDTO transmissionTypeDTO) {
        TransmissionTypeDTO createdTransmissionType = transmissionTypeService.createTransmissionType(transmissionTypeDTO);
     ...
     * @return ResponseEntity with the transmission type DTO if found, otherwise 404 Not Found
     */
     ...
     * @return ResponseEntity with list of all transmission type DTOs and HTTP 200 OK status
     */
    @GetMapping
     ...
     * @return ResponseEntity with the updated transmission type DTO if successful, otherwise 404 Not Found
     */
    @PutMapping("/{transmissionTypeId}")
    public ResponseEntity<TransmissionTypeDTO> updateTransmissionType(@PathVariable UUID transmissionTypeId, @RequestBody TransmissionTypeDTO transmissionTypeDTO) {
