...
public class ScheduleController {
     ...
     * @return ResponseEntity with the created schedule DTO and HTTP 201 Created status
     */
    @PostMapping
     ...
     * @return ResponseEntity with the schedule DTO if found, otherwise 404 Not Found
     */
     ...
     * @return ResponseEntity with the updated schedule DTO if successful, otherwise 404 Not Found
     */
