...
public class BusManufacturerController {
     ...
     * @return ResponseEntity with the created bus manufacturer DTO and HTTP 201
     *         Created status
     */
    @PostMapping
    public ResponseEntity<BusManufacturerDTO> createBusManufacturer(
     ...
     * @return ResponseEntity with the bus manufacturer DTO if found, otherwise 404
     *         Not Found
     */
     ...
     * 
     * @return ResponseEntity with list of all bus manufacturer DTOs and HTTP 200 OK
     *         status
     */
    @GetMapping
    ...
    /**
     * Get all bus manufacturers for a specific agency
     * 
     * @param agencyId the ID of the agency
     * @return ResponseEntity with list of bus manufacturer DTOs for the agency
     */
    @GetMapping("/agency/{agencyId}")
    public ResponseEntity<List<BusManufacturerDTO>> getBusManufacturersByAgency(@PathVariable String agencyId) {
        List<BusManufacturerDTO> busManufacturers = busManufacturerService.getBusManufacturersByAgency(agencyId);
        return new ResponseEntity<>(busManufacturers, HttpStatus.OK);
    }
    ...
    public ResponseEntity<BusManufacturerDTO> updateBusManufacturer(@PathVariable UUID manufacturerId,
            @RequestBody BusManufacturerDTO busManufacturerDTO) {
