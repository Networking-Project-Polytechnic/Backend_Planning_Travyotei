 ...
 * All business logic related to transmission types should be implemented in this service.
 */
@Service
public class TransmissionTypeService {
     ...
     */
    public Optional<TransmissionTypeDTO> updateTransmissionType(UUID transmissionTypeId, TransmissionTypeDTO transmissionTypeDTO) {
