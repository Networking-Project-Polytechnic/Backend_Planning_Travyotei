...
/**
 * Data Transfer Object for BusImage entity.
 * This DTO is used to transfer bus image information between layers of the application.
...
public class BusImageDTO {
    ...
    /**
     * Default constructor for BusImageDTO
     */
    public BusImageDTO() {
    }
     ...
     */
    public BusImageDTO(UUID imageId, UUID busId, String s3BucketName, String s3Key, 
