 ...
 * This DTO is used to transfer bus type information between layers of the application.
...
public class BusTypeDTO {
     ...
     */
    public BusTypeDTO(UUID busTypeId, String busTypeName) {
    ...
    public UUID getBusTypeId() { return busTypeId; }
    public void setBusTypeId(UUID busTypeId) { this.busTypeId = busTypeId; }
