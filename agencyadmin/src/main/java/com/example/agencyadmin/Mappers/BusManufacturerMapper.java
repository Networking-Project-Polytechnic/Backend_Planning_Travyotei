...
/**
 * Mapper class for converting between BusManufacturers entity and
 * BusManufacturerDTO.
 * This mapper is responsible for converting BusManufacturers JPA entities to
 * DTOs and vice versa.
...
public class BusManufacturerMapper {
     ...
     * @return BusManufacturerDTO containing the data from the BusManufacturers
     *         entity
     */
